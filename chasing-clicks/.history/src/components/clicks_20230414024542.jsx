...
const handleButtonClick = () => {
  ...
  const clicks = clicksByLocation[location] || 0;
  ...
  localStorage.setItem('count', newCount.stringify());
  localStorage.setItem('clicksByLocation', JSON.stringify(newClicksByLocation));
};

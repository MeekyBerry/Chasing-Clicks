      ...
      fetch(
        ...
        .then((data) => {
          ...
          setLocationCounts((prevLocationCounts) => {
            const newLocationCounts = { ...prevLocationCounts };
            ...
            if (locationKey in newLocationCounts) {
              ...
              const newCount = newLocationCounts[locationKey] + 1;
              // update the locationCounts dictionary
              newLocationCounts[locationKey] = newCount;
            } else {
              // if it doesn't, set the count to 1
              newLocationCounts[locationKey] = 1;
            }
            return newLocationCounts;
          });
          ...
          db.collection("locationCounts")
            ...
            .then(() => {
              setLocationCounts((prevLocationCounts) => {
                const newLocationCounts = { ...prevLocationCounts };
                newLocationCounts[locationKey] = locationCounts[locationKey];
                return newLocationCounts;
              });

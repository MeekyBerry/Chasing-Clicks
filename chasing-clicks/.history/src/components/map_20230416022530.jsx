...
const ClickCounterMap = () => {
  ...
  return (
    <div className="click">
      ...
      <p className="click--text">I have been clicked <strong className="click--text__count">{clickCount}</strong> times in total</p>
      <p className="click--text">
        I have been clicked in <strong className="click--text__count">{Object.keys(locationCounts).length}</strong> different
        locations
      </p>
      <p className="click--text">
    ...
    <ul>
      {Object.keys(locationCounts).map((key) => {
        ...
        return (
          <li key={key} className="click--locationCount__list--container">
            {state}, {country} ({count})
          </li>
        );
      })}

    ...
    <div className="click">
      ...
      {count > 0 && (
        <p className="click--count">
          You clicked me from <strong>{count}</strong> times.
        </p>
      )}
      {/* Conditionally render state and country */}
      {state && country && (
        <p className="click--location">
          I was just clicked in <strong>{state}</strong>,{" "}
        ...
        <div className="click--locationCount">
          ...
          <ul className="click--locationCount__list">
            {Object.keys(clicksByLocation).map((location) => (
              <li key={location} className="click--locationCount__list--item">

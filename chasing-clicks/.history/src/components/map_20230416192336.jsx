...
const ClickCounterMap = () => {
  ...
  useEffect(() => {
    ...
    db.collection("clicks")
      ...
      .get()
      .then((doc) => {
        // Make sure that the clicks array contains valid objects with the count property. You can add a check to ensure that click.count is not undefined before using it:
        if (doc.exists) {
